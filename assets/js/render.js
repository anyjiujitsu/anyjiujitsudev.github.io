...
function buildPriceInfoIcon(nonMemberRaw, mode = "desktop"){
  ...
  return `<span class="cell__infoIcon cell__infoIcon--${escapeHtml(mode)}" aria-hidden="true"><svg viewBox="0 0 24 24" width="10" height="10" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><line x1="12" y1="10" x2="12" y2="16"></line><circle cx="12" cy="7" r="1"></circle></svg></span>`;
}
